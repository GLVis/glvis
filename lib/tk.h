...
extern GLenum tkInitWindow(const char *);
...
extern Screen *tkGetXScreen(void);
...
extern GLuint tkLoadBitmapFont( const char *name );
extern void tkUnloadBitmapFont( GLuint fontbase );
