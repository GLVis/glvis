...
void Extrude1DMeshAndSolution(mfem::Mesh **mesh_p, mfem::GridFunction **grid_f_p,
                              mfem::Vector *sol);
void SetMeshSolution(mfem::Mesh *mesh, mfem::GridFunction *&grid_f, bool save_coloring);
