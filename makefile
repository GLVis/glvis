...
ALL_SOURCE_FILES = \
 ...
 lib/sdl_helper.cpp lib/stream_reader.cpp lib/threads.cpp lib/vsdata.cpp \
 lib/vssolution.cpp lib/vssolution3d.cpp lib/vsvector.cpp lib/vsvector3d.cpp
OBJC_SOURCE_FILES = $(if $(NOTMAC),,lib/sdl_mac.mm)
DESKTOP_ONLY_SOURCE_FILES = lib/gl/renderer_ff.cpp lib/threads.cpp lib/gl2ps.c lib/sdl_x11.cpp
